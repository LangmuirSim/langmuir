...
namespace Langmuir{
  ...
  ChargeAgent::ChargeAgent(World *world, unsigned int site) : Agent(Agent::Charge, world, site), m_charge(-1), m_removed(false)
  {
...
inline double ChargeAgent::chargedDefects(unsigned int newSite)
 ...
 inline double ChargeAgent::chargedTraps(unsigned int newSite)
 {
  ...
  return m_charge * m_world->parameters()->zTrap * q4pe * (potential2 - potential1);
 }
