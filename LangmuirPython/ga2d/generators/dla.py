...
def create_parser():
    ...
    parser.add_argument(dest='sticky', default=1.0, type=float, nargs='?',
        metavar='spacing', help='gooeyness')
...
if __name__ == '__main__':
    ...
    filename = "DLA-%5.3f-%d.png" % (opts.sticky, random.randrange(1024))
    print filename
            ...
            if image.getpixel((x, y)) == 0:
                ...
                for k in range(nbrs):
                    ...
                    if xn < 0:
                        ...
                        stuck = True
                        break
                    if image.getpixel((xn, yn)) > 0 and random.random() < opts.sticky:
                        image.putpixel((x, y), 255)
                        stuck = True
                        break
