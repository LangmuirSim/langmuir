# -*- coding: utf-8 -*-
#
# Langmuir Python documentation build configuration file, created by
# sphinx-quickstart on Tue Jan 14 13:03:15 2014.
#
...
project = u'Langmuir Python'
copyright = u'2014, Adam Gagorik'
...
latex_documents = [
  ('index', 'LangmuirPython.tex', u'Langmuir Python Documentation',
...
man_pages = [
    ('index', 'langmuirpython', u'Langmuir Python Documentation',
     [u'Adam Gagorik'], 1)
]
